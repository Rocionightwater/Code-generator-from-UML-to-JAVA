...
public class Classe extends DataStructure {
	...
	public void printProp() {
		...
		Logger.getGlobal().log(Level.INFO, "Processing class: " + getName());
	...
	public boolean isPrintImport() {
		return printImport;
	}

	public void setPrintImport(boolean printImport) {
		this.printImport = printImport;
	}
