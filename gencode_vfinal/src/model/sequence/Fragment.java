...
public class Fragment extends DataSequence{
	...
	public Fragment(String name){
		super(name);
		if(name.contains("_Message")&&(name.contains("Send"))&&(!name.contains("Recv"))){
			isSend = true;			
			this.name = name.substring(0, name.indexOf("_Message"));
		}
	...
	public void parser(BufferedReader bf, String line) throws IOException{
		...
		if(name.contains("Message")&&(name.contains("Send"))&&!(name.contains("Recv"))){
			isSend = true;
		}
