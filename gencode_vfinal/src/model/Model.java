...
public class Model {
	...
	protected ArrayList<Enumeration> listEnumeration;
	private ArrayList<Interface> listInterface;
	private ArrayList<Literal> listLiteral;
	...
	private static TreeMap<String,Literal> trieLiteral = new TreeMap<String,Literal>();
	/*
	 * Trie Sequence 				 
	 */
	...
	public Model(String name){
		...
		listEnumeration = new ArrayList<Enumeration>();
	...
	public ArrayList<Enumeration> getListEnumeration(){
	...
	public static void putTrieLiteral(String key, Literal literal){
		trieLiteral.put(key, literal);
	}
	...
	public static Literal getTrieLiteral (String key){
		return key == null ? null : trieLiteral.get(key);
	}
